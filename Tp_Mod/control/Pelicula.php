...
class Pelicula{
    ...
    public function Cargar($data, $dataArc){
        ...
        $this->getObjArchivo()->Cargar($dataArc);       
    }
        ...
        "
            <div class='card'>
                ...
                <div class='col-5 col-sm-4'>
                    <img style='width: 250px; height: 200px;' src='{$this->getObjArchivo()->GenerarRuta()}' alt='{$this->getObjArchivo()->getName()}'>
                </div>
            </div>
        ";
